...
//        <p className="text-gray-300 mb-6 text-center">Use this tool to extract constraints from a paragraph. Helpful when writing complex prompts that need to do specific things reliably.</p>
//
//        <form onSubmit={handleSubmit} className="space-y-4">
//        <div className="relative">
//        <button
